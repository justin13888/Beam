...
| [ADR-0002](ADR-0002-rest-only-api.md) | Accepted | One REST, OpenAPI-first API versioned `/v1`, with progress delivered over SSE; the GraphQL stack was deleted entirely. |
